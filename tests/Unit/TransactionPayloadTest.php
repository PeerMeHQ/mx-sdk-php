...
it('createNft - builds an nft issue payload', function () {
    ...
    expect($actual->data)
        ->toBe('ESDTNFTCreate@534f4d452d31323334@01@536f6d65546f6b656e@04e2@787878414e5948415348787878@746167733a6f6e653b74776f3b6d657461646174613a78797a@68747470733a2f2f616e792e636f6d');
});
...
it('createNft - encodes for the correct royalties hex representation', function (float $percent, string $expectedHex) {
    ...
    expect(explode('@', $actual->data)[$royaltiesArgIndex])
        ->toBe($expectedHex);
})
    ->with([
        [1.1, '6e'],
